...
<section class="content">
	<div class="box box-primary">
		...
		<form action='<c:url value="/qReply.do"/>' method="post" role="form">
			...
			<%-- 원본글 정보 --%>
			<input type="hidden" name="reRef" value="${dto.reRef}" readonly>
			<input type="hidden" name="reSeq" value="${dto.reSeq}" readonly>
			<input type="hidden" name="reLev" value="${dto.reLev}" readonly>
